                ...
                <label
                    ...
                    className={`flex items-center px-4 py-2 rounded-lg border-2 cursor-pointer transition-all duration-200 ${
                        selectedBird?.sabap2 === bird.sabap2
                            ...
                            : 'border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-600 hover:border-blue-300 hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:border-blue-400'
                    }`}
                >
                    <input
                        type="radio"
                    ...
                    />
                    <span className="ml-3 text-gray-800 dark:text-gray-200 font-medium">{bird.fullName}</span>
                </label>
            ))}
        </div>
    );
