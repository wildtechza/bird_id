...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-[radial-gradient(circle_at_top_left,rgba(104,160,70,0.18),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(76,119,255,0.08),transparent_35%),linear-gradient(135deg,#0d1815,#121f1b)] text-[#f5f7f2]">
      <main className="w-full max-w-[860px] p-5 sm:p-7 rounded-[28px] bg-[rgba(20,31,28,0.82)] border border-white/12 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_24px_60px_rgba(0,0,0,0.35)] backdrop-blur-xl">
        <h2 className="m-0 mb-6 text-center text-[#79b84c] text-2xl sm:text-[30px] font-extrabold">
          Ready for a new quiz?
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-[22px]">
          {/* Quiz Type Selection */}
          <section className="p-4 sm:p-[18px] rounded-[22px] bg-white/[0.035] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
            <div className="mb-3 sm:mb-[14px] text-white/72 text-xs sm:text-sm font-bold uppercase tracking-[0.08em]">
              Quiz Type
            </div>
            <div className="grid grid-cols-2 gap-3 sm:gap-[14px]">
              ...
              >
                <span className="w-[66px] h-[66px] rounded-[18px] grid place-items-center bg-[rgba(147,214,91,0.18)] text-[#a8e96f]">
              ...
              >
                <span className="w-[66px] h-[66px] rounded-[18px] grid place-items-center bg-[rgba(255,143,21,0.14)] text-[#ff8f15]">
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <section className="p-4 sm:p-[18px] rounded-[22px] bg-white/[0.035] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-[14px]">
              ...
              >
                <span className="w-[66px] h-[66px] rounded-[18px] grid place-items-center bg-[rgba(70,135,255,0.16)] text-[#5d91ff]">
                  <svg width="34" height="34" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              ...
              >
                <span className="w-[66px] h-[66px] rounded-[18px] grid place-items-center bg-[rgba(154,82,255,0.16)] text-[#a061ff]">
          ...
          <section className="p-4 sm:p-[18px] rounded-[22px] bg-white/[0.035] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:col-span-2 col-span-1">
            <div className="mb-3 sm:mb-[14px] text-white/72 text-xs sm:text-sm font-bold uppercase tracking-[0.08em]">
              Questions
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-[14px]">
              {questionCountOptions.map((num) => (
                <button
                  ...
                  className={`h-[78px] rounded-[18px] text-xl sm:text-2xl font-extrabold transition duration-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] ${count === num
        ...
        <button
          ...
          className="w-full h-20 sm:h-[92px] mt-6 rounded-[24px] bg-[linear-gradient(135deg,#76aa48,#4f872f)] text-white text-2xl sm:text-[30px] font-extrabold shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_16px_36px_rgba(76,128,47,0.35)] transition duration-200 hover:-translate-y-0.5 hover:brightness-105"
        >
          Start New Quiz
        ...
        {/* Selected Summary */}
        <div className="mt-[18px] text-center text-white/68 text-sm">
          Selected:{" "}
