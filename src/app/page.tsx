...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex items-start sm:items-center justify-center p-3 sm:p-6 bg-[radial-gradient(circle_at_top_left,rgba(104,160,70,0.18),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(76,119,255,0.08),transparent_35%),linear-gradient(135deg,#0d1815,#121f1b)] text-[#f5f7f2]">
